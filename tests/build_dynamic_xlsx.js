  ...
  sheets: [
    ...
    },
    {
      ...
      rows: [
        ...
        ["CeCo", "Tienda", "Roll Out", "Rack FHW", "QR - Qualtrics", "Mandil Verde", "Realizadas", "Pendientes", "% Avance"],
        ["38401", "Coacalco", { value: 1, style: 7 }, { value: "", style: 0 }, { value: 1, style: 7 }, { value: 0, style: 8 }, { formula: "SUM(C5:F5)", cached: 2, style: 6 }, { formula: "COUNT(C5:F5)-SUM(C5:F5)", cached: 1, style: 6 }, { formula: "IFERROR(SUM(C5:F5)/COUNT(C5:F5),0)", cached: 2 / 3, style: 3 }],
      ],
      widths: [13, 28, 18, 18, 22, 20, 14, 14, 14],
